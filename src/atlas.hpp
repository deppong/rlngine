...
// a mapping of unicode values to code page 437
// I just realized that this is pretty pointless based on how chars work and the way cp437 is laid out.
// for whatever reason I can't seem to get the ascii values actually converting here, so I'm not sure if I even need it !
static constexpr std::array<uint16_t, 256> CP437 = {
